...
<p>var req = https.request({
  host: ‘download.github.com’,
  port: 443,
  path: ‘/visionmedia-node-jscoverage-0d4608a.zip’
});</p>

<p>req.on(‘response’, function(res){
  var len = parseInt(res.headers[‘content-length’], 10);</p>
...
<p>res.on(‘data’, function (chunk) {
    bar.tick(chunk.length);
  });</p>

<p>res.on(‘end’, function () {
    console.log(‘\n’);
  });
});</p>
