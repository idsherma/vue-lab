...
<a href="https://www.npmjs.com/package/acorn"><img src="https://img.shields.io/npm/v/acorn.svg" alt="NPM version" /></a><br />
...
<p>// transform code to array of tokens:
...
<p>```javascript
var comments = [], tokens = [];</p>

<p>var ast = acorn.parse(‘var x = 42; // answer’, {
...
<p>// attach comments using collected information
escodegen.attachComments(ast, comments, tokens);</p>
