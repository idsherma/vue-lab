<h1>Overview <a href="https://travis-ci.org/lydell/js-tokens"><img src="https://travis-ci.org/lydell/js-tokens.svg?branch=master" alt="Build Status" /></a></h1>

<p>A regex that tokenizes JavaScript.</p>

<p>```js
var jsTokens = require(“js-tokens”).default</p>

<p>var jsString = “var foo=opts.foo;\n…”</p>

<p>jsString.match(jsTokens)
// [“var”, “ “, “foo”, “=”, “opts”, “.”, “foo”, “;”, “\n”, …]
```</p>
