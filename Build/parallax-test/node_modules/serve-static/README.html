...
<p>// Serve up public/ftp folder
var serve = serveStatic(‘public/ftp’, {‘index’: [‘index.html’, ‘index.htm’]})</p>
...
<p>// Set header to force download
...
<p>app.use(serveStatic(‘public/ftp’, {‘index’: [‘default.html’, ‘default.htm’]}))
app.listen(3000)
```</p>
...
<p>app.use(serveStatic(path.join(__dirname, ‘public-optimized’)))
...
<p>app.use(serveStatic(path.join(__dirname, ‘public’), {
  maxAge: ‘1d’,
...
<p>function setCustomCacheControl (res, path) {
