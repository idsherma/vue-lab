<h1>Autoprefixer <a href="https://travis-ci.org/postcss/autoprefixer"><img src="https://travis-ci.org/postcss/autoprefixer.svg" alt="Build Status" /></a></h1>

<p><img align="right" width="94" height="71" src="http://postcss.github.io/autoprefixer/logo.svg" title="Autoprefixer logo by Anton Lovchikov" /></p>
...
var prefixer = postcss([ autoprefixer ]);</p>

<p>cleaner.process(css).then(function (cleaned) {
...
<h4>What is unprefixed version for <code>-webkit-min-device-pixel-ratio</code>?</h4>
...
gulp.task(‘autoprefixer’, function () {
    ...
    var autoprefixer = require(‘autoprefixer’);</p>
...
module.exports = function(grunt) {
    grunt.loadNpmTasks(‘grunt-postcss’);</p>
...
var postcss      = require(‘postcss’);</p>

<p>postcss([ autoprefixer ]).process(css).then(function (result) {
...
<p>b {
    /* autoprefixer: off <em>/
    transition: 1s; /</em> it will not be prefixed */
}
```</p>
...
<p>These browsers account for 0.04% of all users globally</p>
