...
<p>``` js
var eos = require(‘end-of-stream’);</p>

<p>eos(readableStream, function(err) {
  // this will be set to the stream instance
	if (err) return console.log(‘stream had an error or closed early’);
	console.log(‘stream has ended’, this === readableStream);
});</p>

<p>eos(writableStream, function(err) {
	if (err) return console.log(‘stream had an error or closed early’);
	console.log(‘stream has finished’, this === writableStream);
});</p>

<p>eos(duplexStream, function(err) {
	if (err) return console.log(‘stream had an error or closed early’);
	console.log(‘stream has ended and finished’, this === duplexStream);
});</p>

<p>eos(duplexStream, {readable:false}, function(err) {
	if (err) return console.log(‘stream had an error or closed early’);
	console.log(‘stream has finished but might still be readable’);
});</p>

<p>eos(duplexStream, {writable:false}, function(err) {
	if (err) return console.log(‘stream had an error or closed early’);
	console.log(‘stream has ended but might still be writable’);
});</p>

<p>eos(readableStream, {error:false}, function(err) {
