...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">all files</a> / <a class='current-parent' href="index.html">lib/spdy-transport/</a> stream.js
    </h1>
    <div class='clearfix'>
...
709
710
711</td><td class="line-coverage quiet"><span class="cline-any cline-neutral">&nbsp;</span>
...
&nbsp;
Stream.prototype._init = <span class="fstat-no" title="function not covered" >function _init (socket) {</span>
...
&nbsp;
  if (avail === 0) {
    state.window.send.update(0, <span class="fstat-no" title="function not covered" >function () {</span>
...
&nbsp;
  var ended = false
  <span class="missing-if-branch" title="if path not taken" >I</span>if (state.aborted) { <span class="cstat-no" title="statement not covered" >ended = true }</span>
&nbsp;
...
&nbsp;
  state.timeout.reset()
&nbsp;
  <span class="missing-if-branch" title="if path not taken" >I</span>if (!this._checkEnded(callback)) { <span class="cstat-no" title="statement not covered" >return }</span>
&nbsp;
  var frame = {
    id: this.id,
    status: status,
  ...
  state.framer.responseFrame(frame, function (err) {
    self._hardUncork()
    <span class="missing-if-branch" title="if path not taken" >I</span>if (callback) { <span class="cstat-no" title="statement not covered" >callback(err) }</span>
  })
}
&nbsp;
...
&nbsp;
  var delta = state.window.recv.getDelta()
  <span class="missing-if-branch" title="if path not taken" >I</span>if (delta === 0) { <span class="cstat-no" title="statement not covered" >return }</span>
&nbsp;
  state.framer.windowUpdateFrame({
    id: this.id,
    delta: delta
...
&nbsp;
Stream.prototype.destroy = <span class="fstat-no" title="function not covered" >function destroy () {</span>
...
<span class="cstat-no" title="statement not covered" >    if (callback) { <span class="cstat-no" title="statement not covered" >process.nextTick(callback) }</span></span>
<span class="cstat-no" title="statement not covered" >    return</span>
  }
&nbsp;
  state.aborted = true
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (err) { <span class="cstat-no" title="statement not covered" >push.emit('error', err) }</span></span>
  })
  push._hardCork()
&nbsp;
  return push
