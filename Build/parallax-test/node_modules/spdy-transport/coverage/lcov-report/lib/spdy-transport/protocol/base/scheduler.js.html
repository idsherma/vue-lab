...
<html lang="en">
<head>
    <title>Code coverage report for lib/spdy-transport/protocol/base/scheduler.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../../index.html">all files</a> / <a class='current-parent' href="index.html">lib/spdy-transport/protocol/base/</a> scheduler.js
    </h1>
    <div class='clearfix'>
...
&nbsp;
  ...
  this.window = 0.25
&nbsp;
  <span class="missing-if-branch" title="if path not taken" >I</span>if (options &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >options.window)</span> { <span class="cstat-no" title="statement not covered" >this.window = options.window }</span>
&nbsp;
  this.sync = []
  this.list = []
  this.count = 0
...
Scheduler.prototype.tick = function tick () {
  ...
  <span class="missing-if-branch" title="if path not taken" >I</span>if (!this.tickSync()) { <span class="cstat-no" title="statement not covered" >return false }</span>
&nbsp;
...
&nbsp;
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (!res) { <span class="cstat-no" title="statement not covered" >break }</span>
  }
&nbsp;
  return res
}
