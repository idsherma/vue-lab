...
<p>```js
var forOwn = require(‘for-own’);</p>

<p>var obj = {a: ‘foo’, b: ‘bar’, c: ‘baz’};
var values = [];
var keys = [];</p>

<p>forOwn(obj, function (value, key, o) {
  keys.push(key);
  values.push(value);
});</p>
