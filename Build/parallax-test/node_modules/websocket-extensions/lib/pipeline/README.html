...
var crypto = require(‘crypto’),
    ...
    small  = new Buffer(‘hi’);</p>

<p>deflate.outgoing({data: large}, function() {
  console.log(1, ‘large’);
});</p>

<p>deflate.outgoing({data: small}, function() {
  console.log(2, ‘small’);
});</p>
...
var stream  = require(‘stream’),
    session = new stream.Transform({objectMode: true});</p>

<p>session._transform = function(message, _, callback) {
  var self = this;
...
<p>```js
var functor = new Functor(deflate, ‘outgoing’);</p>

<p>functor.call({data: large}, function() {
  console.log(1, ‘large’);
});</p>

<p>functor.call({data: small}, function() {
  console.log(2, ‘small’);
});</p>
