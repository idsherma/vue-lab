<h1>qs <sup><a href="https://npmjs.org/package/qs"><img src="http://versionbadg.es/ljharb/qs.svg" alt="Version Badge" /></a></sup></h1>
...
<p>var obj = qs.parse(‘a=c’);
assert.deepEqual(obj, { a: ‘c’ });</p>

<p>var str = qs.stringify(obj);
...
assert.deepEqual(withEmptyString, { a: [’’, ‘b’] });</p>

<p>var withIndexedEmptyString = qs.parse(‘a[0]=b&a<a href="https://npmjs.org/package/qs">1</a>=&a<a href="http://versionbadg.es/ljharb/qs.svg">2</a>=c’);
