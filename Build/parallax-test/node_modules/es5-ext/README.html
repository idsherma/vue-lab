<h1>es5-ext</h1>
<p>## ECMAScript 5 extensions
### (with respect to ECMAScript 6 standard)</p>
...
<h4>Non ECMAScript standard features</h4>
...
<p>```javascript
var flatten = require(‘es5-ext/array/#/flatten’);</p>

<p>flatten.call([1, [2, [3, 4]]]); // [1, 2, 3, 4]
```</p>
...
var flatten = call.bind(require(‘es5-ext/array/#/flatten’));</p>
...
util.startsWith = call.bind(require(‘es5-ext/string/#/starts-with’));</p>

<p>util.flatten([1, [2, [3, 4]]]); // [1, 2, 3, 4]
```</p>
...
<h3>Global extensions</h3>

<h4>global <em>(es5-ext/global)</em></h4>

<p>Object that represents global scope</p>

<h3>Array Constructor extensions</h3>

<h4>from(arrayLike[, mapFn[, thisArg]]) <em>(es5-ext/array/from)</em></h4>
...
<h4>toArray(obj) <em>(es5-ext/array/to-array)</em></h4>

<p>Returns array representation of <code>obj</code>. If <code>obj</code> is already an array, <code>obj</code> is returned back.</p>

<h4>validArray(obj) <em>(es5-ext/array/valid-array)</em></h4>

<p>Returns <code>obj</code> if it’s an array, otherwise throws <code>TypeError</code></p>

<h3>Array Prototype extensions</h3>

<h4>arr.binarySearch(compareFn) <em>(es5-ext/array/#/binary-search)</em></h4>
...
<h4>arr.clear() <em>(es5-ext/array/#/clear)</em></h4>

<p>Clears the array</p>

<h4>arr.compact() <em>(es5-ext/array/#/compact)</em></h4>

<p>Returns a copy of the context with all non-values (<code>null</code> or <code>undefined</code>) removed.</p>

<h4>arr.concat() <em>(es5-ext/array/#/concat)</em></h4>
...
<h4>arr.contains(searchElement[, position]) <em>(es5-ext/array/#/contains)</em></h4>

<p>Whether list contains the given value.</p>

<h4>arr.copyWithin(target, start[, end]) <em>(es5-ext/array/#/copy-within)</em></h4>

<p><a href="http://people.mozilla.org/~jorendorff/es6-draft.html#sec-array.copywithin"><em>Introduced with ECMAScript 6</em></a>.  </p>

<h4>arr.diff(other) <em>(es5-ext/array/#/diff)</em></h4>

<p>Returns the array of elements that are present in context list but not present in other list.</p>

<h4>arr.eIndexOf(searchElement[, fromIndex]) <em>(es5-ext/array/#/e-index-of)</em></h4>
...
<h4>arr.eLastIndexOf(searchElement[, fromIndex]) <em>(es5-ext/array/#/e-last-index-of)</em></h4>
...
<h4>arr.entries() <em>(es5-ext/array/#/entries)</em></h4>
...
<h4>arr.exclusion([…lists]]) <em>(es5-ext/array/#/exclusion)</em></h4>
...
<h4>arr.fill(value[, start, end]) <em>(es5-ext/array/#/fill)</em></h4>

<p><a href="http://people.mozilla.org/~jorendorff/es6-draft.html#sec-array.fill"><em>Introduced with ECMAScript 6</em></a>.  </p>

<h4>arr.filter(callback[, thisArg]) <em>(es5-ext/array/#/filter)</em></h4>
...
<h4>arr.find(predicate[, thisArg]) <em>(es5-ext/array/#/find)</em></h4>
...
<h4>arr.findIndex(predicate[, thisArg]) <em>(es5-ext/array/#/find-index)</em></h4>
...
<h4>arr.first() <em>(es5-ext/array/#/first)</em></h4>

<p>Returns value for first defined index</p>

<h4>arr.firstIndex() <em>(es5-ext/array/#/first-index)</em></h4>

<p>Returns first declared index of the array</p>

<h4>arr.flatten() <em>(es5-ext/array/#/flatten)</em></h4>

<p>Returns flattened version of the array</p>

<h4>arr.forEachRight(cb[, thisArg]) <em>(es5-ext/array/#/for-each-right)</em></h4>

<p><code>forEach</code> starting from last element</p>

<h4>arr.group(cb[, thisArg]) <em>(es5-ext/array/#/group)</em></h4>

<p>Group list elements by value returned by <em>cb</em> function</p>

<h4>arr.indexesOf(searchElement[, fromIndex]) <em>(es5-ext/array/#/indexes-of)</em></h4>

<p>Returns array of all indexes of given value</p>

<h4>arr.intersection([…lists]) <em>(es5-ext/array/#/intersection)</em></h4>

<p>Computes the array of values that are the intersection of all lists (context list and lists given in arguments)</p>

<h4>arr.isCopy(other) <em>(es5-ext/array/#/is-copy)</em></h4>

<p>Returns true if both context and <em>other</em> lists have same content</p>

<h4>arr.isUniq() <em>(es5-ext/array/#/is-uniq)</em></h4>

<p>Returns true if all values in array are unique</p>

<h4>arr.keys() <em>(es5-ext/array/#/keys)</em></h4>
...
<h4>arr.last() <em>(es5-ext/array/#/last)</em></h4>

<p>Returns value of last defined index</p>

<h4>arr.lastIndex() <em>(es5-ext/array/#/last)</em></h4>

<p>Returns last defined index of the array</p>

<h4>arr.map(callback[, thisArg]) <em>(es5-ext/array/#/map)</em></h4>
...
<h4>arr.remove(value[, …valuen]) <em>(es5-ext/array/#/remove)</em></h4>

<p>Remove values from the array</p>

<h4>arr.separate(sep) <em>(es5-ext/array/#/separate)</em></h4>

<p>Returns array with items separated with <code>sep</code> value</p>

<h4>arr.slice(callback[, thisArg]) <em>(es5-ext/array/#/slice)</em></h4>
...
<h4>arr.someRight(cb[, thisArg]) <em>(es5-ext/array/#/someRight)</em></h4>

<p><code>some</code> starting from last element</p>

<h4>arr.splice(callback[, thisArg]) <em>(es5-ext/array/#/splice)</em></h4>
...
<h4>arr.uniq() <em>(es5-ext/array/#/uniq)</em></h4>

<p>Returns duplicate-free version of the array</p>

<h4>arr.values() <em>(es5-ext/array/#/values)</em></h4>
...
<h4>arr[@@iterator] <em>(es5-ext/array/#/@@iterator)</em></h4>
...
<h3>Boolean Constructor extensions</h3>

<h4>isBoolean(x) <em>(es5-ext/boolean/is-boolean)</em></h4>

<p>Whether value is boolean</p>

<h3>Date Constructor extensions</h3>

<h4>isDate(x) <em>(es5-ext/date/is-date)</em></h4>

<p>Whether value is date instance</p>

<h4>validDate(x) <em>(es5-ext/date/valid-date)</em></h4>

<p>If given object is not date throw TypeError in other case return it.</p>

<h3>Date Prototype extensions</h3>

<h4>date.copy(date) <em>(es5-ext/date/#/copy)</em></h4>

<p>Returns a copy of the date object</p>

<h4>date.daysInMonth() <em>(es5-ext/date/#/days-in-month)</em></h4>

<p>Returns number of days of date’s month</p>

<h4>date.floorDay() <em>(es5-ext/date/#/floor-day)</em></h4>

<p>Sets the date time to 00:00:00.000</p>

<h4>date.floorMonth() <em>(es5-ext/date/#/floor-month)</em></h4>

<p>Sets date day to 1 and date time to 00:00:00.000</p>

<h4>date.floorYear() <em>(es5-ext/date/#/floor-year)</em></h4>

<p>Sets date month to 0, day to 1 and date time to 00:00:00.000</p>

<h4>date.format(pattern) <em>(es5-ext/date/#/format)</em></h4>
...
<h3>Error Constructor extensions</h3>

<h4>custom(message/<em>, code, ext</em>/) <em>(es5-ext/error/custom)</em></h4>
...
<h4>isError(x) <em>(es5-ext/error/is-error)</em></h4>

<p>Whether value is an error (instance of <code>Error</code>).  </p>

<h4>validError(x) <em>(es5-ext/error/valid-error)</em></h4>

<p>If given object is not error throw TypeError in other case return it.</p>

<h3>Error Prototype extensions</h3>

<h4>err.throw() <em>(es5-ext/error/#/throw)</em></h4>

<p>Throws error</p>

<h3>Function Constructor extensions</h3>
...
<h4>constant(x) <em>(es5-ext/function/constant)</em></h4>

<p>Returns a constant function that returns pregiven argument</p>

<p><em>k(x)(y)  =def  x</em></p>

<h4>identity(x) <em>(es5-ext/function/identity)</em></h4>

<p>Identity function. Returns first argument</p>

<p><em>i(x)  =def  x</em></p>

<h4>invoke(name[, …args]) <em>(es5-ext/function/invoke)</em></h4>
...
<h4>isArguments(x) <em>(es5-ext/function/is-arguments)</em></h4>

<p>Whether value is arguments object</p>

<h4>isFunction(arg) <em>(es5-ext/function/is-function)</em></h4>

<p>Whether value is instance of function</p>

<h4>noop() <em>(es5-ext/function/noop)</em></h4>

<p>No operation function</p>

<h4>pluck(name) <em>(es5-ext/function/pluck)</em></h4>
...
<h4>validFunction(arg) <em>(es5-ext/function/valid-function)</em></h4>

<p>If given object is not function throw TypeError in other case return it.</p>

<h3>Function Prototype extensions</h3>
...
<h4>fn.lock([…args]) <em>(es5-ext/function/#/lock)</em></h4>
...
<h4>fn.not() <em>(es5-ext/function/#/not)</em></h4>
...
<h4>fn.partial([…args]) <em>(es5-ext/function/#/partial)</em></h4>
...
<h4>fn.spread() <em>(es5-ext/function/#/spread)</em></h4>
...
<h4>fn.toStringTokens() <em>(es5-ext/function/#/to-string-tokens)</em></h4>
...
<h4>isFinite(x) <em>(es5-ext/number/is-finite)</em></h4>
...
<h4>isInteger(x) <em>(es5-ext/number/is-integer)</em></h4>
...
<h4>isNaN(x) <em>(es5-ext/number/is-nan)</em></h4>
...
<h4>isNumber(x) <em>(es5-ext/number/is-number)</em></h4>

<p>Whether given value is number</p>

<h4>isSafeInteger(x) <em>(es5-ext/number/is-safe-integer)</em></h4>
...
<h4>MAX_SAFE_INTEGER <em>(es5-ext/number/max-safe-integer)</em></h4>
...
<h4>MIN_SAFE_INTEGER <em>(es5-ext/number/min-safe-integer)</em></h4>
...
<h4>toInteger(x) <em>(es5-ext/number/to-integer)</em></h4>

<p>Converts value to integer</p>

<h4>toPosInteger(x) <em>(es5-ext/number/to-pos-integer)</em></h4>

<p>Converts value to positive integer. If provided value is less than 0, then 0 is returned</p>

<h4>toUint32(x) <em>(es5-ext/number/to-uint32)</em></h4>
...
<h3>Number Prototype extensions</h3>

<h4>num.pad(length[, precision]) <em>(es5-ext/number/#/pad)</em></h4>

<p>Pad given number with zeros. Returns string</p>

<h3>Object Constructor extensions</h3>

<h4>assign(target, source[, …sourcen]) <em>(es5-ext/object/assign)</em></h4>
...
<h4>eq(x, y) <em>(es5-ext/object/eq)</em></h4>
...
<h4>every(obj, cb[, thisArg[, compareFn]]) <em>(es5-ext/object/every)</em></h4>
...
<h4>filter(obj, cb[, thisArg]) <em>(es5-ext/object/filter)</em></h4>
...
<h4>getPropertyNames() <em>(es5-ext/object/get-property-names)</em></h4>

<p>Get all (not just own) property names of the object</p>

<h4>is(x, y) <em>(es5-ext/object/is)</em></h4>
...
<h4>map(obj, cb[, thisArg]) <em>(es5-ext/object/map)</em></h4>
...
<h4>mapKeys(obj, cb[, thisArg]) <em>(es5-ext/object/map-keys)</em></h4>

<p>Create new object with same values, but remapped keys</p>

<h4>mixin(target, source) <em>(es5-ext/object/mixin)</em></h4>
...
<h4>mixinPrototypes(target, …source]) <em>(es5-ext/object/mixin-prototypes)</em></h4>
...
<h4>normalizeOptions(options) <em>(es5-ext/object/normalize-options)</em></h4>
...
<h4>setPrototypeOf(object, proto) <em>(es5-ext/object/set-prototype-of)</em></h4>
...
<h4>some(obj, cb[, thisArg[, compareFn]]) <em>(es5-ext/object/some)</em></h4>

<p>Analogous to Array.prototype.some Returns true if any key-value pair satisfies the provided
testing function.<br />
Optionally <em>compareFn</em> can be provided which assures that keys are tested in given order. If provided <em>compareFn</em> is equal to <code>true</code>, then order is alphabetical (by key).</p>

<h4>toArray(obj[, cb[, thisArg[, compareFn]]]) <em>(es5-ext/object/to-array)</em></h4>
...
<h4>re.isUnicode(x) <em>(es5-ext/reg-exp/#/is-unicode)</em></h4>
...
<h4>re.match(string) <em>(es5-ext/reg-exp/#/match)</em></h4>
...
<h4>re.replace(string, replaceValue) <em>(es5-ext/reg-exp/#/replace)</em></h4>
...
<h4>re.search(string) <em>(es5-ext/reg-exp/#/search)</em></h4>
...
<h4>re.split(string) <em>(es5-ext/reg-exp/#/search)</em></h4>
...
<h4>re.sticky <em>(es5-ext/reg-exp/#/sticky/implement)</em></h4>
...
<h4>re.unicode <em>(es5-ext/reg-exp/#/unicode/implement)</em></h4>
...
<h3>String Constructor extensions</h3>

<h4>formatMethod(fMap) <em>(es5-ext/string/format-method)</em></h4>

<p>Creates format method. It’s used e.g. to create <code>Date.prototype.format</code> method</p>

<h4>fromCodePoint([…codePoints]) <em>(es5-ext/string/from-code-point)</em></h4>
...
<h4>str.camelToHyphen() <em>(es5-ext/string/#/camel-to-hyphen)</em></h4>
...
<h4>str.capitalize() <em>(es5-ext/string/#/capitalize)</em></h4>

<p>Capitalize first character of a string</p>

<h4>str.caseInsensitiveCompare(str) <em>(es5-ext/string/#/case-insensitive-compare)</em></h4>

<p>Case insensitive compare</p>

<h4>str.codePointAt(pos) <em>(es5-ext/string/#/code-point-at)</em></h4>
...
<h4>str.contains(searchString[, position]) <em>(es5-ext/string/#/contains)</em></h4>
...
<h4>str.endsWith(searchString[, endPosition]) <em>(es5-ext/string/#/ends-with)</em></h4>
...
<h4>str.hyphenToCamel() <em>(es5-ext/string/#/hyphen-to-camel)</em></h4>
...
<h4>str.indent(str[, count]) <em>(es5-ext/string/#/indent)</em></h4>

<p>Indents each line with provided <em>str</em> (if <em>count</em> given then <em>str</em> is repeated <em>count</em> times).</p>

<h4>str.last() <em>(es5-ext/string/#/last)</em></h4>

<p>Return last character</p>

<h4>str.normalize([form]) <em>(es5-ext/string/#/normalize)</em></h4>
...
<h4>str.pad(fill[, length]) <em>(es5-ext/string/#/pad)</em></h4>
...
<h4>str.repeat(n) <em>(es5-ext/string/#/repeat)</em></h4>
...
<h4>str.plainReplace(search, replace) <em>(es5-ext/string/#/plain-replace)</em></h4>
...
<h4>str.plainReplaceAll(search, replace) <em>(es5-ext/string/#/plain-replace-all)</em></h4>
...
<h4>str.startsWith(searchString[, position]) <em>(es5-ext/string/#/starts-with)</em></h4>
...
<h4>str[@@iterator] <em>(es5-ext/string/#/@@iterator)</em></h4>
...
<h3>Tests <a href="https://circleci.com/gh/medikoo/es5-ext"><img src="https://img.shields.io/circleci/project/github/medikoo/es5-ext.svg" alt="Build Status" /></a></h3>
