<h1>define-properties <sup><a href="https://npmjs.org/package/define-properties"><img src="http://versionbadg.es/ljharb/define-properties.svg" alt="Version Badge" /></a></sup></h1>
...
<p>Then, with predicates:
```js
var define = require(‘define-properties’);
var assert = require(‘assert’);</p>

<p>var obj = define({ a: 1, b: 2, c: 3 }, {
	a: 10,
	b: 20,
	c: 30
}, {
