...
<p>var smc = new SourceMapConsumer(rawSourceMap);</p>

<p>console.log(smc.sources);
// [ ‘http://example.com/www/js/one.js’,
//   ‘http://example.com/www/js/two.js’ ]</p>

<p>console.log(smc.originalPositionFor({
  line: 2,
  column: 28
}));
...
<p>console.log(smc.generatedPositionFor({
  source: ‘http://example.com/www/js/two.js’,
  line: 2,
  column: 10
}));
...
<p>```js
// Node.js
var sourceMap = require(‘source-map’);</p>

<p>// Browser builds
var sourceMap = window.sourceMap;</p>
...
<p>consumer.computeColumnSpans();</p>
...
<p>consumer.originalPositionFor({ line: 99999999999999999, column: 999999999999999 })
// { source: null,
//   line: null,
//   column: null,
//   name: null }
...
<p>consumer.sourceContentFor(“my-cool-lib.clj”)
// “…”</p>

<p>consumer.sourceContentFor(“this is not in the source map”);
// Error: “this is not in the source map” is not in the source map</p>

<p>consumer.sourceContentFor(“this is not in the source map”, true);
// null
```</p>
...
<p>node.walk(function (code, loc) { console.log(“WALK:”, code, loc); })
...
c.setSourceContent(“c.js”, “original c”);</p>

<p>var node = new SourceNode(null, null, null, [a, b, c]);
...
var rhs = new SourceNode(5, 6, “a.rs”, “orig.clone()”);</p>

<p>var node = new SourceNode(null, null, null, [ lhs, operand, rhs ]);
...
<p>node.toStringWithSourceMap({ file: “my-output-file.js” })
