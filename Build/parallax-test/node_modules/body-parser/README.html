...
<p>// parse application/x-www-form-urlencoded
app.use(bodyParser.urlencoded({ extended: false }))</p>

<p>// parse application/json
...
<p>// create application/json parser
var jsonParser = bodyParser.json()</p>

<p>// create application/x-www-form-urlencoded parser
var urlencodedParser = bodyParser.urlencoded({ extended: false })</p>

<p>// POST /login gets urlencoded bodies
app.post(‘/login’, urlencodedParser, function (req, res) {
  if (!req.body) return res.sendStatus(400)
  res.send(‘welcome, ‘ + req.body.username)
})</p>

<p>// POST /api/users gets JSON bodies
...
<p>// parse various different custom JSON types as JSON
app.use(bodyParser.json({ type: ‘application/*+json’ }))</p>

<p>// parse some custom thing into a Buffer
app.use(bodyParser.raw({ type: ‘application/vnd.custom-type’ }))</p>

<p>// parse an HTML body into a string
