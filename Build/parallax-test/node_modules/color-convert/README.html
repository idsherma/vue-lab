...
<p>```js
var convert = require(‘color-convert’);</p>

<p>convert.rgb.hsl(140, 200, 100);             // [96, 48, 59]
convert.keyword.rgb(‘blue’);                // [0, 0, 255]</p>

<p>var rgbChannels = convert.rgb.channels;     // 3
...
convert.hex.lab.raw(‘DEADBF’);     // [ 75.56213190997677, 20.653827952644754, -2.290532499330533 ]</p>
...
<p>convert.rgb.hex(123, 45, 67);      // ‘7B2D43’
