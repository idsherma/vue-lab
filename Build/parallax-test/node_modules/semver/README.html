...
Prints valid versions sorted by SemVer precedence</version></version></p>

<p>Options:
-r –range <range>
        Print versions that match the specified range.</range></p>

<p>-i –increment [<level>]
        Increment a version by the specified level.  Level can
        be one of: major, minor, patch, premajor, preminor,
        prepatch, or prerelease.  Default level is 'patch'.
        Only one version may be specified.</level></p>

<p>–preid <identifier>
        Identifier to be used to prefix premajor, preminor,
        prepatch or prerelease version increments.</identifier></p>
