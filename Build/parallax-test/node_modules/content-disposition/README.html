...
var onFinished = require(‘on-finished’)</p>

<p>var filePath = ‘/path/to/public/plans.pdf’</p>

<p>http.createServer(function onRequest(req, res) {
  // set headers
  res.setHeader(‘Content-Type’, ‘application/pdf’)
  res.setHeader(‘Content-Disposition’, contentDisposition(filePath))</p>
