(function() {
  var ParsedError, PrettyError, RenderKid, array, defaultStyle, fn, instance, j, len, nodePaths, object, prop, ref, ref1,
    slice = [].slice,
    indexOf = [].indexOf || function(item) { for (var i = 0, l = this.length; i < l; i++) { if (i in this && this[i] === item) return i; } return -1; };

  ref = require('utila'), object = ref.object, array = ref.array;
  ...
  module.exports = PrettyError = (function() {
    ...
    PrettyError.prototype.getObject = function(e) {
      var count, header, i, item, j, len, obj, ref1, traceItems;
    ...
    PrettyError.prototype._skipOrFilter = function(item, itemNumber) {
      var cb, j, k, l, len, len1, len2, len3, m, modName, pair, ref1, ref2, ref3, ref4, ref5, ref6;
      if (typeof item === 'object') {
        if (ref1 = item.modName, indexOf.call(this._packagesToSkip, ref1) >= 0) {
          return true;
        }
        if (ref2 = item.path, indexOf.call(this._pathsToSkip, ref2) >= 0) {
          return true;
        }
        ref3 = item.packages;
