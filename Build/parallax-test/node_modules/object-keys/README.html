<h1>object-keys <sup><a href="https://npmjs.org/package/object-keys"><img src="http://versionbadg.es/ljharb/object-keys.svg" alt="Version Badge" /></a></sup></h1>
...
<p>assert.deepEqual(keys(obj), [‘a’, ‘b’, ‘c’]);
```</p>
