...
<p>var server = http.createServer(function (req, res) {
  var done = finalhandler(req, res)</p>

<p>fs.readFile(‘index.html’, function (err, buf) {
...
<p>var serve = serveStatic(‘public’)</p>
...
<p>var server = http.createServer(function (req, res) {
  var done = finalhandler(req, res, {onerror: logerror})</p>
