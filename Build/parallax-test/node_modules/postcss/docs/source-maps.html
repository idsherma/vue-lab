...
<ul>
  <li>
    <p><code>inline</code> boolean: indicates that the source map should be embedded
...
A different path can be set by providing a string value for <code>annotation</code>.</p>
  ...
  <li>
    <p><code>from</code> string: by default, PostCSS will set the <code>sources</code> property of the map
