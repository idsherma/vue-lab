<h1>supports-color <a href="https://travis-ci.org/chalk/supports-color"><img src="https://travis-ci.org/chalk/supports-color.svg?branch=master" alt="Build Status" /></a></h1>
...
<p>```js
var supportsColor = require(‘supports-color’);</p>

<p>if (supportsColor) {
	console.log(‘Terminal supports color’);
}</p>

<p>if (supportsColor.has256) {
	console.log(‘Terminal supports 256 colors’);
}</p>

<p>if (supportsColor.has16m) {
