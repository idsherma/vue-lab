...
<p>ajv.validate(schema, validData); // true
```</p>
...
<pre><code>return parentSchema.exclusiveRange === true
        ? function (data) { return data > min && data < max; }
        : function (data) { return data >= min && data <= max; }   } });
</code></pre>

<p>var schema = { “range”: [2, 4], “exclusiveRange”: true };
var validate = ajv.compile(schema);
...
<p>```javascript
var ajv = new Ajv({ loadSchema: loadSchema });</p>

<p>ajv.compileAsync(schema).then(function (validate) {
  var valid = validate(data);
  // …
});</p>

<p>function loadSchema(uri) {
...
<p>```javascript
/**
 * Default mode is non-transpiled generator function wrapped with <code>co</code>.
...
<p>var setupAsync = require(‘ajv-async’);
var ajv = setupAsync(new Ajv);</p>

<p>ajv.addKeyword(‘idExists’, {
  async: true,
  type: ‘number’,
  validate: checkIdExists
});</p>

<p>function checkIdExists(schema, data) {
...
<p>var validate = ajv.compile(schema);</p>

<p>validate({ userId: 1, postId: 19 })
.then(function (data) {
...
<p>var data = {
  “foo”: 0,
  “additional1”: 1, // will be removed; <code>additionalProperties</code> == false
  “bar”: {
    “baz”: “abc”,
    “additional2”: 2 // will NOT be removed; <code>additionalProperties</code> != false
  },
}</p>

<p>var validate = ajv.compile(schema);</p>

<p>console.log(validate(data)); // true
...
<p>```javascript
var ajv = new Ajv({ useDefaults: ‘shared’ });</p>
...
<h5><a name="api-compileAsync"></a>.compileAsync(Object schema [, Boolean meta] [, Function callback]) -> Promise</h5>
