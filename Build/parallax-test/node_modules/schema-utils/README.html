...
<div align="center">
  <a href="http://json-schema.org">
    ...
    <img width="180" height="180" src="https://raw.githubusercontent.com/json-schema-org/json-schema-org.github.io/master/img/logo.png" />
  </a>
  <a href="https://github.com/webpack/webpack">
    <img width="200" height="200" hspace="10" src="https://webpack.js.org/assets/icon-square-big.svg" />
  </a>
  <h1>Schema Utils</h1>
</div>
...
<h3><code>validateOptions</code></h3>

<p>```js
import validateOptions from ‘schema-utils’</p>

<p>validateOptions(‘path/to/schema.json’, options, ‘Loader/Plugin Name’)
```</p>
...
<p>function loader (src, map) {
  const options = getOptions(this) || {}</p>

<p>validateOptions(‘path/to/schema.json’, options, ‘Loader Name’)
}
```</p>
...
<p>class Plugin extends Tapable {
  constructor (options) {
