<h1>pinkie-promise <a href="https://travis-ci.org/floatdrop/pinkie-promise"><img src="https://travis-ci.org/floatdrop/pinkie-promise.svg?branch=master" alt="Build Status" /></a></h1>
...
<p>```js
var Promise = require(‘pinkie-promise’);</p>

<p>new Promise(function (resolve) { resolve(‘unicorns’); });
//=> Promise { ‘unicorns’ }
```</p>
