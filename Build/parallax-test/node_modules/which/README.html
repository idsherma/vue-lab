...
<p>// sync usage
// throws if not found
var resolved = which.sync(‘node’)</p>

<p>// if nothrow option is used, returns null if not found
resolved = which.sync(‘node’, {nothrow: true})</p>

<p>// Pass options to override the PATH and PATHEXT environment vars.
