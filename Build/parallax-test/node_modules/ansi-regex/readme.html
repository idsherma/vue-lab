<h1>ansi-regex <a href="https://travis-ci.org/chalk/ansi-regex"><img src="https://travis-ci.org/chalk/ansi-regex.svg?branch=master" alt="Build Status" /></a></h1>
...
<p>```js
const ansiRegex = require(‘ansi-regex’);</p>

<p>ansiRegex().test(‘\u001b[4mcake\u001b[0m’);
//=> true</p>

<p>ansiRegex().test(‘cake’);
//=> false</p>

<p>‘\u001b[4mcake\u001b[0m’.match(ansiRegex());
//=> [‘\u001b[4m’, ‘\u001b[0m’]
```</p>
