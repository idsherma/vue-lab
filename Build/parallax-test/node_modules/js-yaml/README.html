...
<p>```
usage: js-yaml [-h] [-v] [-c] [-t] file</p>

<p>Positional arguments:
  file           File with YAML document(s)</p>
...
<p>// Get document, or throw exception on error
try {
...
<p>``` javascript
var untrusted_code = ‘“toString”: !<tag:yaml.org,2002:js/function> “function (){very_evil_thing();}”’;</p>

<p>// I’m just converting that string, what could possibly go wrong?
require(‘js-yaml’).load(untrusted_code) + ‘’
```</p>

<h3>safeLoadAll (string [, iterator] [, options ])</h3>
...
<p>``` javascript
var yaml = require(‘js-yaml’);</p>

<p>yaml.safeLoadAll(data, function (doc) {
  console.log(doc);
});
```</p>

<h3>loadAll (string [, iterator] [ , options ])</h3>
...
<p>!!int
  ...
  “octal”       -> “01”, “052”, “016172”
  “decimal”     => “1”, “42”, “7290”
  “hexadecimal” -> “0x1”, “0x2A”, “0x1C7A”</p>

<p>!!bool
  “lowercase”   => “true”, “false”
  “uppercase”   -> “TRUE”, “FALSE”
  “camelcase”   -> “True”, “False”</p>
