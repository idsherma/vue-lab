...
<p>kindOf(new Number(42));
//=> ‘number’</p>

<p>kindOf(‘str’);
//=> ‘string’</p>

<p>kindOf(new String(‘str’));
//=> ‘string’</p>
...
<p>kindOf(new Function());
//=> ‘function’</p>

<p>kindOf(new Map());
//=> ‘map’</p>

<p>kindOf(new WeakMap());
//=> ‘weakmap’</p>

<p>kindOf(new Set());
//=> ‘set’</p>

<p>kindOf(new WeakSet());
//=> ‘weakset’</p>

<p>kindOf(Symbol(‘str’));
//=> ‘symbol’</p>

<p>kindOf(new Int8Array());
//=> ‘int8array’</p>

<p>kindOf(new Uint8Array());
//=> ‘uint8array’</p>

<p>kindOf(new Uint8ClampedArray());
//=> ‘uint8clampedarray’</p>

<p>kindOf(new Int16Array());
//=> ‘int16array’</p>

<p>kindOf(new Uint16Array());
//=> ‘uint16array’</p>

<p>kindOf(new Int32Array());
//=> ‘int32array’</p>

<p>kindOf(new Uint32Array());
//=> ‘uint32array’</p>

<p>kindOf(new Float32Array());
//=> ‘float32array’</p>

<p>kindOf(new Float64Array());
//=> ‘float64array’
```</p>
...
#1: array
  ...
  lib-typeof x 9,686,935 ops/sec ±0.59% (98 runs sampled)</p>

<h1>2: boolean</h1>
<p>current x 27,197,115 ops/sec ±0.85% (94 runs sampled)
  lib-type-of x 3,145,791 ops/sec ±0.73% (97 runs sampled)
  lib-typeof x 9,199,562 ops/sec ±0.44% (99 runs sampled)</p>

<h1>3: date</h1>
<p>current x 20,190,117 ops/sec ±0.86% (92 runs sampled)
  lib-type-of x 5,166,970 ops/sec ±0.74% (94 runs sampled)
  lib-typeof x 9,610,821 ops/sec ±0.50% (96 runs sampled)</p>

<h1>4: function</h1>
<p>current x 23,855,460 ops/sec ±0.60% (97 runs sampled)
  lib-type-of x 5,667,740 ops/sec ±0.54% (100 runs sampled)
  lib-typeof x 10,010,644 ops/sec ±0.44% (100 runs sampled)</p>

<h1>5: null</h1>
<p>current x 27,061,047 ops/sec ±0.97% (96 runs sampled)
  lib-type-of x 13,965,573 ops/sec ±0.62% (97 runs sampled)
  lib-typeof x 8,460,194 ops/sec ±0.61% (97 runs sampled)</p>

<h1>6: number</h1>
<p>current x 25,075,682 ops/sec ±0.53% (99 runs sampled)
  lib-type-of x 2,266,405 ops/sec ±0.41% (98 runs sampled)
  lib-typeof x 9,821,481 ops/sec ±0.45% (99 runs sampled)</p>

<h1>7: object</h1>
<p>current x 3,348,980 ops/sec ±0.49% (99 runs sampled)
  lib-type-of x 3,245,138 ops/sec ±0.60% (94 runs sampled)
  lib-typeof x 9,262,952 ops/sec ±0.59% (99 runs sampled)</p>

<h1>8: regex</h1>
<p>current x 21,284,827 ops/sec ±0.72% (96 runs sampled)
  lib-type-of x 4,689,241 ops/sec ±0.43% (100 runs sampled)
  lib-typeof x 8,957,593 ops/sec ±0.62% (98 runs sampled)</p>

<h1>9: string</h1>
<p>current x 25,379,234 ops/sec ±0.58% (96 runs sampled)
  lib-type-of x 3,635,148 ops/sec ±0.76% (93 runs sampled)
  lib-typeof x 9,494,134 ops/sec ±0.49% (98 runs sampled)</p>

<h1>10: undef</h1>
<p>current x 27,459,221 ops/sec ±1.01% (93 runs sampled)
  lib-type-of x 14,360,433 ops/sec ±0.52% (99 runs sampled)
  lib-typeof x 23,202,868 ops/sec ±0.59% (94 runs sampled)</p>
...
<ul>
  <li>
    <table>
      <tbody>
        <tr>
          <td><a href="https://www.npmjs.com/package/is-glob">is-glob</a>: Returns <code>true</code> if the given string looks like a glob pattern or an extglob pattern… <a href="https://github.com/jonschlinkert/is-glob">more</a></td>
  ...
  <li>
    <table>
      <tbody>
        <tr>
          <td><a href="https://www.npmjs.com/package/is-primitive">is-primitive</a>: Returns <code>true</code> if the value is a primitive.</td>
