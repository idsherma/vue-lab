...
<p>```javascript
var Gauge = require(“gauge”)</p>

<p>var gauge = new Gauge()</p>
...
<p>var gauge = new Gauge([stream], [options])
```</p>
...
to <code>gauge/themes</code>, see the <a href="#themes">themes</a> documentation for details.</li>
...
a width of <code>79</code> is assumed.</li>
  <li><strong>enabled</strong>: Defaults to true if <code>tty</code> is a TTY, false otherwise.  If true
the gauge starts enabled.  If disabled then all update commands are
ignored and no gauge will be printed until you call <code>.enable()</code>.</li>
...
<p>```
var themes = require(‘gauge/themes’)</p>

<p>// fetch the default color unicode theme for this platform
var ourTheme = themes({hasUnicode: true, hasColor: true})</p>

<p>// fetch the default non-color unicode theme for osx
var ourTheme = themes({hasUnicode: true, hasColor: false, platform: ‘darwin’})</p>

<p>// create a new theme based on the color ascii theme for this platform
...
<p>#### themes.addTheme(themeName, [parentTheme], newTheme)</p>
