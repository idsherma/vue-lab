...
<p>```js
var cache = require(‘regex-cache’);</p>

<p>function yourRegex(str, opts) {
  // do stuff to str and opts
  return new RegExp(str, opts.flags);
}</p>

<p>var regex = cache(yourRegex);
```</p>
...
# no args passed (defaults)
  ...
  without-cache x 2,777,551 ops/sec ±0.63% (95 runs sampled)</p>

<h1>string and six options passed</h1>
<p>with-cache x 1,885,934 ops/sec ±0.80% (93 runs sampled)
  without-cache x 1,256,893 ops/sec ±0.65% (97 runs sampled)</p>

<h1>string only</h1>
<p>with-cache x 7,723,256 ops/sec ±0.87% (92 runs sampled)
  without-cache x 2,303,060 ops/sec ±0.47% (99 runs sampled)</p>

<h1>one option passed</h1>
<p>with-cache x 4,179,877 ops/sec ±0.53% (100 runs sampled)
  without-cache x 2,198,422 ops/sec ±0.47% (95 runs sampled)</p>

<h1>two options passed</h1>
<p>with-cache x 3,256,222 ops/sec ±0.51% (99 runs sampled)
  without-cache x 2,121,401 ops/sec ±0.79% (97 runs sampled)</p>

<h1>six options passed</h1>
<p>with-cache x 1,816,018 ops/sec ±1.08% (96 runs sampled)
  without-cache x 1,157,176 ops/sec ±0.53% (100 runs sampled)</p>

<p># 
# diminishing returns happen about here
# </p>

<h1>ten options passed</h1>
<p>with-cache x 1,210,598 ops/sec ±0.56% (92 runs sampled)
  without-cache x 1,665,588 ops/sec ±1.07% (100 runs sampled)</p>

<h1>twelve options passed</h1>
<p>with-cache x 1,042,096 ops/sec ±0.68% (92 runs sampled)
  without-cache x 1,389,414 ops/sec ±0.68% (97 runs sampled)</p>

<h1>twenty options passed</h1>
<p>with-cache x 661,125 ops/sec ±0.80% (93 runs sampled)
  without-cache x 1,208,757 ops/sec ±0.65% (97 runs sampled)</p>

<p># 
# when non-primitive values are compared
# </p>

<h1>single value on the options is an object</h1>
<p>with-cache x 1,398,313 ops/sec ±1.05% (95 runs sampled)
...
<p><em>This file was generated by <a href="https://github.com/verbose/verb-generate-readme">verb-generate-readme</a>, v0.6.0, on September 01, 2017.</em></p>