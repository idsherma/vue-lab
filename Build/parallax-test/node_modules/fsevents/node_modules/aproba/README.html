...
<p>```
var validate = require(“aproba”)</p>

<p>function myfunc(a, b, c) {
  // <code>a</code> must be a string, <code>b</code> a number, <code>c</code> a function
  validate(‘SNF’, arguments) // [a,b,c] is also valid
}</p>

<p>myfunc(‘test’, 23, function () {}) // ok
myfunc(123, 23, function () {}) // type error
myfunc(‘test’, 23) // missing arg error
myfunc(‘test’, 23, function () {}, true) // too many args error</p>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td>E</td>
      <td>instanceof Error OR null <strong>(special: see below)</strong></td>
    </tr>
    <tr>
      <td>Z</td>
      <td>== null</td>
