...
<p>```javascript
var TrackerGroup = require(“are-we-there-yet”).TrackerGroup</p>

<p>var top = new TrackerGroup(“program”)</p>

<p>var single = top.newItem(“one thing”, 100)
single.completeWork(20)</p>

<p>console.log(top.completed()) // 0.2</p>

<p>fs.stat(“file”, function(er, stat) {
  if (er) throw er<br />
