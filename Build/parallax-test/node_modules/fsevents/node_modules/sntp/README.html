...
<p>// Request server time</p>

<p>Sntp.time(options, function (err, time) {</p>
...
<p>```javascript
// Request offset once</p>

<p>Sntp.offset(function (err, offset) {</p>

<pre><code>console.log(offset);                    // New (served fresh)
...
<p>```javascript
var before = Sntp.now();                    // System time without offset</p>

<p>Sntp.start(function () {</p>

<pre><code>var now = Sntp.now();                   // With offset
Sntp.stop(); }); ```
</code></pre>