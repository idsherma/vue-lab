...
const wrapAnsi = require(‘wrap-ansi’);</p>

<p>const input = ‘The quick brown ‘ + chalk.red(‘fox jumped over ‘) +
	‘the lazy ‘ + chalk.green(‘dog and then ran away with the unicorn.’);</p>

<p>console.log(wrapAnsi(input, 20));
```</p>
