<h1>readdirp <a href="http://travis-ci.org/thlorenz/readdirp"><img src="https://secure.travis-ci.org/thlorenz/readdirp.png" alt="Build Status" /></a></h1>
...
var readdirp = require(‘readdirp’)
  , path = require(‘path’)
  , es = require(‘event-stream’);</p>

<p>// print out all JavaScript files along with their size</p>

<p>var stream = readdirp({ root: path.join(__dirname), fileFilter: ‘*.js’ });
stream
...
readdirp({ root: ‘./test/bed’, fileFilter: [ ‘<em>.js’, ‘</em>.json’ ] })
  .on(‘data’, function (entry) {
