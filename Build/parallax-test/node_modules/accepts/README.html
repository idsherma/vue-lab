...
<p>function app (req, res) {
  var accept = accepts(req)</p>

<p>// the order of this list is significant; should be server preferred order
...
<p>http.createServer(app).listen(3000)
```</p>
