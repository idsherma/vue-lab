...
<p>```js
const chalk = require(‘chalk’);</p>

<p>console.log(chalk.blue(‘Hello world!’));
```</p>
...
const log = console.log;</p>

<p>// Combine styled and normal strings
log(chalk.blue(‘Hello’) + ‘World’ + chalk.red(‘!’));</p>

<p>// Compose multiple styles using the chainable API
log(chalk.blue.bgRed.bold(‘Hello world!’));</p>

<p>// Pass in multiple arguments
log(chalk.blue(‘Hello’, ‘World!’, ‘Foo’, ‘bar’, ‘biz’, ‘baz’));</p>

<p>// Nest styles
log(chalk.red(‘Hello’, chalk.underline.bgBlue(‘world’) + ‘!’));</p>

<p>// Nest styles of the same type even (color, underline, background)
log(chalk.green(
	‘I am a green line ‘ +
...
<p>// ES2015 tagged template literal
log(chalk<code>
...
<p>// Use RGB colors in terminal emulators that support it.
...
<p>const error = chalk.bold.red;
const warning = chalk.keyword(‘orange’);</p>
...
<p>const miles = 18;
const calculateFeet = miles => miles * 5280;</p>

<p>console.log(chalk<code>
